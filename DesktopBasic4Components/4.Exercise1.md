...
<br>The organizing team has created a share folder for materials. We could write our data to it directly, but instead let's write the file to our system, then copy it to the centrally shared folder.
